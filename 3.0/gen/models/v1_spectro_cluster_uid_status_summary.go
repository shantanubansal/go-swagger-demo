...
type V1SpectroClusterUIDStatusSummary struct {
	...
	// nested
	Nested *V1Nested `json:"nested,omitempty"`
...
func (m *V1SpectroClusterUIDStatusSummary) validateNested(formats strfmt.Registry) error {
...
func (m *V1SpectroClusterUIDStatusSummary) contextValidateNested(ctx context.Context, formats strfmt.Registry) error {
