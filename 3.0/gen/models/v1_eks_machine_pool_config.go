	...
	if m.InfraProfileRef != nil {
		if err := m.InfraProfileRef.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("infraProfileRef")
			}
			return err
		}
	}
...
func (m *V1EksMachinePoolConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateInfraProfileRef(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1EksMachinePoolConfig) contextValidateInfraProfileRef(ctx context.Context, formats strfmt.Registry) error {

	if m.InfraProfileRef != nil {
		if err := m.InfraProfileRef.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("infraProfileRef")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("infraProfileRef")
...
func (m *V1EksMachinePoolConfig) contextValidateInfraProfileTemplate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1EksMachinePoolConfig) contextValidateMachines(ctx context.Context, formats strfmt.Registry) error {
