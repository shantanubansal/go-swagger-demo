...
func (m *V1MachinePoolMeta) validateCloudType(formats strfmt.Registry) error {
...
func (m *V1MachinePoolMeta) contextValidateCloudType(ctx context.Context, formats strfmt.Registry) error {
