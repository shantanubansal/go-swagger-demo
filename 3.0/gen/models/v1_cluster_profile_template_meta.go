...
// ContextValidate validate this v1 cluster profile template meta based on the context it is used
func (m *V1ClusterProfileTemplateMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterProfileTemplateMeta) contextValidateCloudType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterProfileTemplateMeta) contextValidatePacks(ctx context.Context, formats strfmt.Registry) error {
