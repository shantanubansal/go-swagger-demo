...
// ContextValidate validate this v1 spectro cluster health status based on the context it is used
func (m *V1SpectroClusterHealthStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SpectroClusterHealthStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SpectroClusterHealthStatus) contextValidateLastHeartBeatTimestamp(ctx context.Context, formats strfmt.Registry) error {
