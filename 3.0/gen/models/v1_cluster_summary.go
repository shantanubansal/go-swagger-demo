...
// ContextValidate validate this v1 cluster summary based on the context it is used
func (m *V1ClusterSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterSummary) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterSummary) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterSummary) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
// ContextValidate validate this v1 cluster summary spec based on the context it is used
func (m *V1ClusterSummarySpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterSummarySpec) contextValidateCloudConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterSummarySpec) contextValidateCloudaccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterSummarySpec) contextValidateClusterProfileTemplate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterSummarySpec) contextValidateClusterProfileTemplates(ctx context.Context, formats strfmt.Registry) error {
