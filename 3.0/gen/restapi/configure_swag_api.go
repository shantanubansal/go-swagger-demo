...
import (
	...
	v1 "github.com/shantanubansal/go-swagger-demo/3.0/gen/restapi/operations/v1"
)

//go:generate swagger generate server --target ../../gen --name SwagAPI --spec ../../spec/swag_api.yaml --principal interface{}
